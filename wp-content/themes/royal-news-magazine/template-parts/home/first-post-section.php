...
$four_column_post_one_category = $royal_news_magazine_options['four_column_post_one_category'];
$content_length = '250';


$four_column_post_one_title = $royal_news_magazine_options['four_column_post_one_title'];
...
<?php
if ($four_column_post_one_category && 'none' != $four_column_post_one_category) {
    $args = [
        'post_type' => 'post',
        'posts_per_page' => 4,
        'post_status' => 'publish',
        ...
        'tax_query' => [
            ...
            [
                'taxonomy' => 'category',
                'field' => 'slug',
                'terms' => [$four_column_post_one_category],
            ],
        ],
    ];
} else {
    ...
    <div class="container">
        ...
        <div class="title-wrap">
                            <?php
                             ...
                             if ($four_column_post_one_title):
                                echo '<h3>' . esc_html($four_column_post_one_title) . '</h3>';
