...
$eight_post_section_category = $royal_news_magazine_options['eight_post_section_category'];
$eight_post_section_title = $royal_news_magazine_options['eight_post_section_title'];
?>

<?php
if ($eight_post_section_category && 'none' != $eight_post_section_category) {
    $args = [
        'post_type' => 'post',
        'posts_per_page' => 4,
        'post_status' => 'publish',
        ...
        'tax_query' => [
            ...
            [
                'taxonomy' => 'category',
                'field' => 'slug',
                'terms' => [$eight_post_section_category],
            ],
        ],
    ];
} else {
    ...
    <div class="container">
        ...
        <div class="title-wrap">
                            <?php
                             ...
                             if ($eight_post_section_title):
                                echo '<h3>' . esc_html($eight_post_section_title) . '</h3>';
