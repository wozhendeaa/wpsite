<?php
/* Adv 125x125 */
add_action( 'widgets_init', 'himer_widget_adv125x125_widget' );
function himer_widget_adv125x125_widget() {
...
class Widget_Adv125x125 extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'adv125x125-widget',himer_theme_name.' - Adv 125x125', $widget_ops, $control_ops );
	}
		...
		if ($show_ads == true) {
			...
			echo stripcslashes($before_widget);
				if ($title) {
					...
					echo "<h3 class='screen-reader-text'>".esc_html__("Adv 125x125","himer")."</h3>";
				}?>
				<div class="aalan-wrap">
					<div class="aalan aalan-4a">
						<?php if (has_wpqa() && wpqa_plugin_version >= "5.8") {
							echo wpqa_widget_ads($adv_type_1,$adv_link_1,$adv_href_1,$adv_img_1,$adv_code_1,'aalan-1').
							wpqa_widget_ads($adv_type_2,$adv_link_2,$adv_href_2,$adv_img_2,$adv_code_2,'aalan-1').
							wpqa_widget_ads($adv_type_3,$adv_link_3,$adv_href_3,$adv_img_3,$adv_code_3,'aalan-1').
							wpqa_widget_ads($adv_type_4,$adv_link_4,$adv_href_4,$adv_img_4,$adv_code_4,'aalan-1');
						}?>
					</div><!-- End aalan -->
