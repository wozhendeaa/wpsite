 ...
 * $image = himer_resize( $thumb, '', 140, 110, true );
 * ?>
 *
 * @param int $attach_id
 ...
 * @return array
 */
if ( ! function_exists( 'himer_resize' ) ) :

	function himer_resize( $attach_id = null, $img_url = null, $width = 0, $height = 0, $crop = false , $gif = false , $retina = false ) {
		global  $blog_id;
		$img_url_o = $img_url;
		$divider=1;
		if ($retina==true)
...
function himer_image_crop_dimensions($default, $orig_w, $orig_h, $new_w, $new_h, $crop){
...
add_filter('image_resize_dimensions', 'himer_image_crop_dimensions', 10, 6);?>