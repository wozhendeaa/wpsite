...
$group_pagination   = himer_options("group_pagination");
if (isset($wp_page_template) && $wp_page_template == "template-groups.php") {
	$custom_group_setting = himer_post_meta("custom_group_setting",$post_id_main);
	if ($custom_group_setting == "on") {
		$page_tamplate    = true;
		$group_pagination = himer_post_meta("group_pagination",$post_id_main);
		$group_number     = himer_post_meta("group_number",$post_id_main);
		$group_display    = himer_post_meta("group_display_g",$post_id_main);
		$group_order      = himer_post_meta("group_order_g",$post_id_main);
	}
}
