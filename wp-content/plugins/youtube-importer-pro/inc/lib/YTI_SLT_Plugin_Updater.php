...
class YTI_SLT_Plugin_Updater {
	...
	public function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
		 ...
		 */
		do_action( 'post_YTI_SLT_plugin_updater_setup', $edd_plugin_data );
	...
	public function show_update_notification( $file, $plugin ) {
		...
		if ( ! empty( $update_cache->response[ $this->name ]->sections->changelog ) ) {
			$changelog_link = add_query_arg(
				array(
					'YTI_SLT_action' => 'view_plugin_changelog',
	...
	public function show_changelog() {
		...
		if ( empty( $_REQUEST['YTI_SLT_action'] ) || 'view_plugin_changelog' !== $_REQUEST['YTI_SLT_action'] ) {
			return;
		}
	...
	private function get_version_from_remote() {
		 ...
		 */
		$api_params = apply_filters( 'YTI_SLT_plugin_updater_api_params', $api_params, $this->api_data, $this->plugin_file );
	...
	private function verify_ssl() {
		return (bool) apply_filters( 'YTI_SLT_api_request_verify_ssl', true, $this );
	}
	...
	private function get_cache_key() {
		...
		return 'YTI_SLT_' . md5( serialize( $string ) );
	}
