...
?>
	...
	*/
	...
	public function restore_backup_btn($backup, $file_exists, $file_url)
	{
		...
		?>
			<button data-file-url="<?php echo $file_url; ?>" data-id="<?php echo $backup['id_wtmgdp_log']; ?>" title="<?php _e('Restore', 'wp-migration-duplicator'); ?>" class="button button-secondary wt_mgdp_restore_backup" style=""><span class="dashicons dashicons-backup" style="margin-top:4px; color: black"></span></button>
		<?php
		}
