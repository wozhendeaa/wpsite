                ...
                <table class="wf-form-table" style="max-width:650px;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="wt-migrator-input wt-migrator-file" name="wt_mgdb_s3bucket_file_name_schedule" value= <?php echo $file_name; ?> disabled placeholder="e.g. critical-backup" style="width: 320px;margin-left: 25px;"/>
                            </td>
                        </tr>
                    </tbody>
                </table>
