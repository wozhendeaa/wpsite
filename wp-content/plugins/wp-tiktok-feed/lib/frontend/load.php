...
use QUADLAYERS\TIKTOK\Api\Rest\Endpoints\Frontend\UserVideoList\Load as API_Rest_User_Video_List;
use QUADLAYERS\TIKTOK\Api\Rest\Endpoints\Frontend\TrendingVideoList\Load as API_Rest_Trending_Video_List;
use QUADLAYERS\TIKTOK\Api\Rest\Endpoints\Frontend\HashtagVideoList\Load as API_Rest_Hashtag_Video_List;
use QUADLAYERS\TIKTOK\Api\Rest\Endpoints\Frontend\ExternalUserProfile\Load as API_Rest_Frontend_External_Profile;
use QUADLAYERS\TIKTOK\Api\Rest\Endpoints\Frontend\ExternalUserVideoList\Load as API_Rest_Frontend_External_Video_List;
		...
		wp_localize_script(
			...
			array(
				'restRoutePaths' => array(
					'account_profile'          => API_Rest_User_Profile::get_rest_url(),
					...
					'username_profile' => API_Rest_Frontend_External_Profile::get_rest_url(),
				),
				'settings'       => $settings,
			)
		);
