...
class WpforoUcfSecondary_groups extends WpforoUcfAbstractField {
    ...
    public function fieldAddEditAllowedGroupIds() {
        include WPFUCF_DIR_PATH . '/includes/fields/html/add-edit/attributes/allowed-secondary-group-ids.php';
    }
