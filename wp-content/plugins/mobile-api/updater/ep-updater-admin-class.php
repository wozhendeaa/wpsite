		...
		function insert_deactivation_form(){
			...
			<div id="<?php echo esc_attr($modal_id) ?>" class="ep-modal <?php echo "{$this->prefix}-ep-modal" ?>">
				<div class="ep-modal-header">
					...
					<button class="ep-modal-close <?php echo esc_attr($modal_id) ?>-cancel dashicons dashicons-no"><span class="screen-reader-text"><?php echo ($this->strings('cancel')); ?></span></button>
				</div>
				...
				<div class="ep-modal-footer">
					<div>
						<a id="<?php echo esc_attr($modal_id) ?>-send-deactivation" href="#" class="button button-primary ep-modal-disabled ep-send-deactivation" disabled><?php echo ($this->strings('send')); ?></a>
						<button class="button button-secondary <?php echo esc_attr($modal_id) ?>-cancel"><?php echo ($this->strings('cancel')); ?></button>
					</div>
					<a href="#" id="<?php echo esc_attr($modal_id) ?>-deactivation-skip" class="button button-secondary ep-deactivate-skip"><?php echo ($this->strings('skip')); ?></a>
				</div>
			</div>
