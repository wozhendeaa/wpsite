...
function wpqa_other_plugin() {
	if (is_admin() && !function_exists('mobile_api_options') && !function_exists('mobile_options')) {
		add_filter(wpqa_prefix_theme."_options_after_general_setting","wpqa_mobile_setting_options");
	}
}
...
function wpqa_mobile_setting_options($options) {
	...
	$options[] = array(
		'name'  => sprintf(esc_html__('You can get the reCaptcha v2 site and secret keys from: %s','wpqa'),'<a href="https://www.google.com/recaptcha/admin/" target="_blank">'.esc_html__('here','wpqa').'</a> > <a href="https://ahmed.d.pr/DUAKq5" target="_blank">'.esc_html__('like that','wpqa').'</a>'),
		'class' => 'home_page_display',
		'type'  => 'info'
	);
