	...
	if (jQuery(".review-post").length) {
		jQuery(document).on("click",".review-post,.a-pending-post,.d-pending-post,.b-pending-post,.u-pending-post",function () {
			...
			if (pending_post.hasClass("review-post")) {
				main_post.find(".all_not_single_post_content,.review-post").slideUp(200);
				main_post.find(".all_single_post_content,.a-pending-post,.d-pending-post,.e-pending-post,.b-pending-post,.u-pending-post").slideDown(200).css({"display":"inline-block"});
			}else {
