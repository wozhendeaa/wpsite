...
function wpqa_posts_row_actions($actions,WP_Post $post) {
    ...
    if ($post->post_status == 'publish') {
	    $actions['posts-edit'] = "<a href='".wpqa_custom_permalink($post->ID,"view_posts_group","view_group_post")."'>".esc_html("View","wpqa").'</a>';
	}
    return $actions;
}
/* Posts link */
...
function wpqa_group_posts_link($post_link,$post) {
	...
	$post_link = wpqa_custom_permalink($post->ID,"view_posts_group","view_group_post");
	return $post_link;
}?>