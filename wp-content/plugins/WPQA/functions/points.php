							...
							<div class="point-section point-section-div points-card buy-points-card">
								...
								<div class="buy-points-content">';
									if (is_user_logged_in() || (!is_user_logged_in() && $unlogged_pay == "on")) {
										if ($price > 0) {
											$out .= '<a href="'.wpqa_checkout_link("buy_points",(int)$value["package_points"]).'" target="_blank" class="button-default btn btn__primary btn__sm">'.esc_html__("Buy points","wpqa").'</a>
