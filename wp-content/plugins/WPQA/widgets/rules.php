				...
				echo ($before_widget);
					...
					<div class="widget-wrap">
						<div class="widget_group_rules">
							<div class="less_group_rules"><?php echo wpqa_excerpt_any(20,do_shortcode(wpqa_kses_stip(nl2br($group_rules))),'<a class="read_more_rules btn btn__link" href="#">'.esc_html__("See more","wpqa").'</a>','words')?></div>
							<div class="wpqa_hide full_group_rules"><?php echo do_shortcode(wpqa_kses_stip(nl2br($group_rules))).'<a class="read_less_rules btn btn__link" href="#">'.esc_html__("See less","wpqa").'</a>'?></div>
						</div>
					</div>
