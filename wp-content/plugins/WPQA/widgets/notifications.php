...
class Widget_Notifications extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		if (is_user_logged_in()) {
			...
			$item_number = (int)(isset($instance['item_number'])?$instance['item_number']:5);
			$more_button = (isset($instance['more_button'])?esc_html($instance['more_button']):'');
			...
			echo ($before_widget);
				...
				<div class="widget-wrap">
				    <div class="user-notifications user-profile-area custom__notifications">
				    	<?php 
				    	$user_id = get_current_user_id();
				    	echo wpqa_get_notifications($user_id,$item_number,$more_button,false,true,'list-unstyled mb-0');?>
