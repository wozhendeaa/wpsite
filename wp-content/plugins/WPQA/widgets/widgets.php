...
require_once plugin_dir_path(dirname(__FILE__)).'widgets/important_notices.php';
require_once plugin_dir_path(dirname(__FILE__)).'widgets/knowledgebases_categories.php';
...
require_once plugin_dir_path(dirname(__FILE__)).'widgets/related.php';
