                        ...
                        <div class="wpf-field">
                            <div class="wpf-field-wrap" style="text-align:center; width:100%;">
                                <p class="wpf-extra wpfcl-1">
                                    ...
                                    <a href="<?php echo wpforo_lostpassword_url(); ?>" class="wpf-forgot-pass"><?php wpforo_phrase( 'Lost your password?' ) ?></a>
                                </p>
                                <input type="submit" name="wpforologin" value="<?php wpforo_phrase( 'Sign In' ) ?>"/>
								<?php if( wpforo_setting( 'authorization', 'user_register' ) ): ?>
                                    <div class="wpf-field-reg"><?php wpforo_register_link() ?></div>
								<?php endif; ?>
                            </div>
                            <div class="wpf-field-cl"></div>
                        </div>
